    ...
    <div>
      <Section title={t('gridSize')}>
        <Row label={t('colLabel')}>
          <Stepper value={grid.cols} min={1} max={15} onDecrement={removeColumn} onIncrement={addColumn} label={t('colUnit')} />
        </Row>
        <Row label={t('rowLabel')}>
          <Stepper value={grid.rows} min={1} max={15} onDecrement={removeRow} onIncrement={addRow} label={t('rowUnit')} />
        </Row>
      </Section>
